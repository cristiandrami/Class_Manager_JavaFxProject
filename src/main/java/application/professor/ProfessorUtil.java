...
public class ProfessorUtil 
{
	...
	//****************************** COMMON *******************************************************************//
	public static final String BACKTOHOMEPROBLEM = "problema con il settaggio dell'home page professore";
	public static final String IMAGEPATH = "Nuovo voto...";

	
	//*********************************************** ASSIGNMENT PAGE ***************************************//
	public static final String ASSIGNMENTPROBLEM = "Sembra ci sia un problema con i compiti assegnati... assicurati di aver riempito il campo";
	public static final String ASSIGNMENTSENT = "Compiti assegnati correttamente";
	public static final String PROMTTEXTINSERTASSIGNMENT = "Inserisci compiti da assegnare...";
